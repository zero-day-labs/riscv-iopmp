...

{
	...
	registers: [
        ...
        { 
            name: "SRCMD_EN",
            desc: "Bitmapped MD enable register low bits.",
            swaccess: "rw",
            hwaccess: "hro",
            fields: [
                {
                    ...
                    swaccess: "rw1ss",
                    hwaccess: "hro",
                    desc: "A sticky lock bit. When set, locks SRCMD_EN, SRCMD_R and SRCMD_W",
                    resval: "0"
                }
                {
                    bits: "31:1",
                    ...
                    swaccess: "rw",
                    hwaccess: "hro",
                    desc: "md[j] = 1 indicates md j is associated with SID .",
                    resval: "0"
                }
            ]
        },
        { 
            name: "SRCMD_ENH",
            desc: "Bitmapped MD enable register high bits.",
            swaccess: "rw",
            hwaccess: "hro",
            fields: [
                {
                    bits: "31:0",
                    name: "mdh",
                    desc: "mdh[j] = 1 indicates (md j+31) is associated with SID .",
                    resval: "0"
                }
            ]
        },
        ...
        { 
            name: "SRCMD_R",
            desc: '''
                (Optional) Bitmapped MD read enable register low bits,
            ...
            fields: [
                {
                    bits: "31:1",
                    name: "md",
                    desc: "md[j] = 1 indicates SID  has read permission to the corresponding MD[j].",
                    resval: "0"
                }
            ]
        },
        { 
            name: "SRCMD_RH",
            desc: '''
                (Optional)Bitmapped MD read enable register high bits,
                it indicate source s read permission on MDs.
            ''',
            swaccess: "rw",
            hwaccess: "hro",
            fields: [
                {
                    bits: "31:0",
                    name: "mdh",
                    desc: "mdh[j] = 1 indicates SID  has read permission to MD([j]+31).",
                    resval: "0"
                }
            ]
        },
        { 
            name: "SRCMD_W",
            desc: '''
                (Optional)Bitmapped MD write enable register low bits,
            ...
            fields: [
                {
                    bits: "31:1",
                    name: "md",
                    desc: "md[j] = 1 indicates SID  has write permission to the corresponding MD[j].",
                    resval: "0"
                }
            ]
        },
        { 
            name: "SRCMD_WH",
            desc: '''
                (Optional)Bitmapped MD write eanble register high bits,
                it indicate source s write permission on MDs.
            ''',
            swaccess: "rw",
            hwaccess: "hro",
            fields: [
                {
                    bits: "31:0",
                    name: "mdh",
                    desc: "mdh[j] = 1 indicates SID  has write permission to MD([j]+31).",
                    resval: "0"
                }
            ]
        }
        ...
        { 
            name: "ENTRY_ADDR",
            desc: "IOPMP entrie number  low bits of physical address of protected memory region",
            swaccess: "rw",
            hwaccess: "hro",
            fields: [
                {
                    bits: "31:0",
                    name: "addr",
                    desc: "The low bits physical address of protected memory region entrie .",
                    resval: "0"
                }
            ]
        },
        { 
            name: "ENTRY_ADDRH",
            desc:  "IOPMP entrie number  high bits of physical address of protected memory region",
            swaccess: "rw",
            hwaccess: "hro",
            fields: [
                {
                    bits: "31:0",
                    name: "addrh",
                    desc: "The high bits physical address of protected memory region entrie .",
                    resval: "0"
                }
            ]
        },
        { 
            name: "ENTRY_CFG",
            desc: "IOPMP entrie number  configuration register.",
            swaccess: "rw",
            hwaccess: "hro",
            fields: [
                {
                    bits: "0",
                    name: "r",
                    desc: "The read permission to protected memory region entrie ",
                    resval: "0"
                }
                {
                    bits: "1",
                    name: "w",
                    desc: "The write permission to protected memory region entrie ",
                    resval: "0"
                }
                {
                    bits: "2",
                    name: "x",
                    desc: "The execute permission to protected memory region entrie ",
                    resval: "0"
                }
                {
                    bits: "4:3",
        ...
        % if enable_usr_cfg == 1 :
        {skipto: "${entry_offset + 0xC}"}
        { 
            name: "ENTRY_USER_CFG",
            desc: "Users defined additional IOPMP check rules entriy ",
            swaccess: "rw",
            hwaccess: "hro",
            fields: [
                {
                    bits: "31:0",
                    name: "im",
                    desc: "User customized permission field entry ",
                    resval: "0"
                }
            ]
        }
